...
// ── Admin / aggregation (read-only) ──
function allUsers() { return db.users.slice(); }
function allProperties() { return db.properties.slice(); }
function allPendingSubscriptions() { return db.pendingSubscriptions.slice(); }
...
module.exports = {
  ...
  allUsers, allProperties, allPendingSubscriptions,
  countUsers, DATA_DIR,
};
